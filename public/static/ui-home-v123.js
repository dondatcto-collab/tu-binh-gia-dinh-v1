...
(function(){
  ...
  function styles(){if(document.getElementById('home-v123-style'))return;const s=document.createElement('style');s.id='home-v123-style';s.textContent=`
    ...
    @media(max-width:640px){.home-v123-context{overflow:auto}.home-v123-row{grid-template-columns:32px minmax(0,1fr) 16px}.home-v123-state{grid-column:2;justify-self:start}.home-v123-arrow{grid-column:3;grid-row:1 / span 3}.home-v123-icon{grid-row:1 / span 3}}
