...
function badgeClass(label=''){if(/Không ưu tiên|JI/i.test(label))return'bad';if(/Phù hợp theo Hiệp Kỷ|^Phù hợp$/i.test(label))return'good';if(/Có thể cân nhắc|Cân nhắc|lưu ý/i.test(label))return'warn';return'neutral'}
