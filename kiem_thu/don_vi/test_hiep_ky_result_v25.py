...
def test_schema_overlay_declares_partial_not_full_classical_coverage():
    ...
    e7=out["hiep_ky_v30e7"]; assert e7["activated_token"]=="天喜"; assert e7["calculator"]=="SEASON_DAY_BRANCH_V30E7"
    e8=out["hiep_ky_v30e8"]; assert e8["activated_token"]=="五合"; assert e8["calculator"]=="DAY_BRANCH_V30E8"
    e9=out["hiep_ky_v30e9"]; assert e9["extension_version"]=="V3_0E9_TIAN_YI"; assert e9["activated_token"]=="天醫"; assert e9["activated_token_vi"]=="Thiên Y"; assert e9["calculator"]=="MONTH_BRANCH_DAY_BRANCH_V30E9"; assert e9["decision_effect"]=="FAVORABLE_SUPPORT_ONLY"; assert e9["creates_hard_block"] is False; assert e9["full_classical_claim"] is False; assert e9["numeric_score"] is None; assert out["numeric_score"]=="LOCKED_OFF"


def test_event_search_result_keeps_rules_sources_and_no_score():
    raw={"viec":"KY_HOP_DONG","so_ngay_da_quet":1,"xep_hang_status":"ORDINAL_V25_HARD_BLOCK_EVENT_PERSONAL","top":[{"ngay":"2026-09-01","label":"Không ưu tiên","decision_state":"CAUTION","hard_block":False,"rank_group":4,"event_state":"CAUTION","personal_v1_1":{},"reasons":["reason"],"mapping_status":"VERIFIED","coverage":"V3_0E9_PARTIAL_12_TRUC_PLUS_MONTH_BRANCH_11_PLUS_DAY_STEM_3_PLUS_SEASON_STEM_1_PLUS_DAY_PILLAR_1_PLUS_SEASON_DAY_PILLAR_1_PLUS_SEASON_BRANCH_1_PLUS_DAY_BRANCH_1_PLUS_MONTH_DAY_BRANCH_1","hiep_ky_extension":"V3_0E9_TIAN_YI","rule_ids":["HK25-X"],"source_ids":["SRC-HK-QD-V11-WIKISOURCE"],"matched_evidence":[{"rule_id":"HK25-X","source_id":"SRC-HK-QD-V11-WIKISOURCE"}],"active_hiep_ky_tokens":["月厭"],"matched_yi_tokens":[],"matched_ji_tokens":["月厭"],"decision_authority":"EVENT","event_state_v1":"NEUTRAL","event_signal_v25":"CAUTION"}]}
    out=event_search_v25(raw); item=out["results"][0]
    assert out["hiep_ky_extension"]=="V3_0E9_TIAN_YI"; assert out["numeric_score"] is None; assert item["rules"]==["HK25-X"]; assert item["sources"]==["SRC-HK-QD-V11-WIKISOURCE"]; assert item["technical"]["matched_ji_tokens"]==["月厭"]; assert item["technical"]["hiep_ky_extension"]=="V3_0E9_TIAN_YI"; assert item["numeric_score"] is None
