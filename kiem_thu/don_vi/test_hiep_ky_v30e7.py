...
def test_v30e7_capability_schema_and_score_remain_explicit_after_later_releases():
    cap=capability_inventory(); assert cap["token_count"]==81; assert "天喜" in cap["active_tokens"]; assert token_capability("天喜")["calculator"]=="SEASON_DAY_BRANCH_V30E7"; assert cap["numeric_score"] is None
