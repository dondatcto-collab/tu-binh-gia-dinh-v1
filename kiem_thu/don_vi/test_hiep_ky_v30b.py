...
def test_v30b_tokens_remain_active_after_later_releases():
    cap=capability_inventory(); assert cap["token_count"]==81; assert {"劫煞","災煞","月煞"}.issubset(set(cap["active_tokens"])); assert cap["numeric_score"] is None
...
def test_v30b_schema_remains_explicit_after_later_releases():
