...
def test_v30b_tokens_remain_active_after_v30e1():
...
def test_v30b_favorable_relation_cannot_override_jie_sha_caution():
    base={"event_code":"KY_HOP_DONG","event_state":"NEUTRAL","mapping_status":"VERIFIED","rule_ids":[],"reasons":[]}
...
def test_v30b_existing_hard_block_still_wins():
    base={"event_code":"KY_HOP_DONG","event_state":"JI","mapping_status":"VERIFIED","rule_ids":[],"reasons":[]}
    out=evaluate_event_v25(base,_neutral_personal("SUPPORT"),chi_thang="DAN",chi_ngay="HOI")
...
def test_v30b_schema_remains_explicit_after_v30e1():
