...
def test_v30b_tokens_remain_active_after_v30e4():
    cap=capability_inventory(); assert cap["token_count"]==81; assert cap["active_calculable_count"]==24; assert cap["pending_calculator_count"]==57; assert {"劫煞","災煞","月煞"}.issubset(set(cap["active_tokens"])); assert cap["coverage"]=="12_TRUC_PLUS_MONTH_BRANCH_11_PLUS_DAY_STEM_3_PLUS_SEASON_STEM_1"; assert cap["extension_version"]=="V3_0E4_SI_XIANG"; assert cap["numeric_score"] is None
...
def test_v30b_schema_remains_explicit_after_v30e4():
