...
def test_v30d_shi_de_remains_active_after_later_releases():
    cap=capability_inventory(); assert cap["token_count"]==81; assert "時徳" in cap["active_tokens"]; assert cap["numeric_score"] is None
...
def test_v30d_schema_remains_explicit_after_later_releases():
