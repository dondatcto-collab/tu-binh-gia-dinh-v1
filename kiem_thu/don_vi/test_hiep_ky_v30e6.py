...
def test_v30e6_capability_schema_and_score_remain_explicit_after_later_releases():
    cap=capability_inventory(); assert cap["token_count"]==81; assert "天赦" in cap["active_tokens"]; assert token_capability("天赦")["calculator"]=="SEASON_DAY_PILLAR_V30E6"; assert cap["numeric_score"] is None
