...
def test_v30e6_capability_schema_and_score_are_explicit_after_v30e7():
    cap=capability_inventory(); assert cap["token_count"]==81; assert cap["active_calculable_count"]==27; assert cap["pending_calculator_count"]==54; assert {"天赦","天喜"}.issubset(set(cap["active_tokens"])); assert token_capability("天赦")["calculator"]=="SEASON_DAY_PILLAR_V30E6"; assert cap["coverage"]=="12_TRUC_PLUS_MONTH_BRANCH_11_PLUS_DAY_STEM_3_PLUS_SEASON_STEM_1_PLUS_DAY_PILLAR_1_PLUS_SEASON_DAY_PILLAR_1_PLUS_SEASON_BRANCH_1"; assert cap["extension_version"]=="V3_0E7_TIAN_XI"; assert cap["numeric_score"] is None
