    ...
    return {
        "chuyen_sau": {
            "ngay": {
                "danh_gia": {
                    "state": state,
                    "theme": {"theme_group": theme_group, "theme": "Tài chính, tài sản và quản lý nguồn lực", "ten_god": "CHINH_TAI", "ten_god_vi": "Chính Tài", "rule_id": "TT-001", "source_id": "SRC-TT", "verification_status": "VERIFIED"},
...
def test_schema_status_opens_only_finance_next():
    s = schema_status()
    assert s["schema_version"] == "2.2-alpha.1"
