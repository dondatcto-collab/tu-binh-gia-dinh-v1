...
def test_v30e1_yue_de_remains_active_after_later_releases():
    cap=capability_inventory(); assert cap["token_count"]==81; assert "月徳" in cap["active_tokens"]; assert token_capability("月徳")["calculator"]=="MONTH_BRANCH_DAY_STEM_V30E3"
...
def test_v30e1_schema_remains_explicit_after_later_releases():
