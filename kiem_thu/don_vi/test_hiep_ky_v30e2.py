...
def test_v30e2_remains_active_after_v30e7():
    cap=capability_inventory(); assert cap["active_calculable_count"]==27; assert cap["pending_calculator_count"]==54; assert "月徳合" in cap["active_tokens"]; assert "天喜" in cap["active_tokens"]
