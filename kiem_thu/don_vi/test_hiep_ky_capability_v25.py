from loi.quyet_dinh.hiep_ky_capability_v25 import (
    ...
    SEASON_GUAN_RI_TOKENS, SEASON_MIN_RI_TOKENS, SEASON_WANG_RI_TOKENS, SEASON_XIANG_RI_TOKENS,
    TRUC_TOKEN_TO_CODE, capability_inventory, token_capability,
)
...
def test_current_global_capability_is_checked_only_here():
    ...
    assert s["active_calculable_count"]==35
    assert s["pending_calculator_count"]==46
    assert s["extension_version"]=="V3_0E15_MIN_RI"
