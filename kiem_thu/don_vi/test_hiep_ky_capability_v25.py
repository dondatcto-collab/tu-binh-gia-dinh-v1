from loi.quyet_dinh.hiep_ky_capability_v25 import (
    ...
    MONTH_TIAN_HOU_TOKENS, MONTH_TIAN_MA_TOKENS, PAIRED_MONTH_DAY_BRANCH_TOKENS,
    QUARTERED_MONTH_DAY_BRANCH_TOKENS, SEASON_DAY_BRANCH_TOKENS, SEASON_DAY_PILLAR_TOKENS,
    SEASON_DAY_STEM_TOKENS, SEASON_GUAN_RI_TOKENS, SEASON_MIN_RI_TOKENS,
    SEASON_WANG_RI_TOKENS, SEASON_XIANG_RI_TOKENS, TRUC_TOKEN_TO_CODE,
...
def test_current_global_capability_is_checked_only_here():
    s=capability_inventory(); assert s["token_count"]==81; assert s["active_calculable_count"]==39; assert s["pending_calculator_count"]==42; assert s["extension_version"]=="V3_0E19_TIAN_MA"; assert s["numeric_score"] is None; assert s["numeric_score_status"]=="LOCKED_OFF"
