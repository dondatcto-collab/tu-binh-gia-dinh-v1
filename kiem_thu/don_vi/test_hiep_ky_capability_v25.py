from loi.quyet_dinh.hiep_ky_capability_v25 import (
    ...
    MONTH_TIAN_HOU_TOKENS, MONTH_TIAN_MA_TOKENS, MONTH_JI_QI_TOKENS,
...
def test_current_global_capability_is_checked_only_here():
    s=capability_inventory(); assert s["token_count"]==81; assert s["active_calculable_count"]==40; assert s["pending_calculator_count"]==41; assert s["extension_version"]=="V3_0E20_JI_QI"; assert s["numeric_score"] is None; assert s["numeric_score_status"]=="LOCKED_OFF"
