from loi.quyet_dinh.hiep_ky_capability_v25 import (
    DAY_BRANCH_TOKENS, DAY_CHU_SHEN_TOKENS, MONTH_BRANCH_DAY_BRANCH_TOKENS, MONTH_BRANCH_DAY_PILLAR_TOKENS,
...
def test_current_global_capability_is_checked_only_here():
    s=capability_inventory(); assert s["token_count"]==81; assert s["active_calculable_count"]==42; assert s["pending_calculator_count"]==39; assert s["extension_version"]=="V3_0E22_CHU_SHEN"; assert s["numeric_score"] is None; assert s["numeric_score_status"]=="LOCKED_OFF"
