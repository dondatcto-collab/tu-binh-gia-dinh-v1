from loi.quyet_dinh.hiep_ky_capability_v25 import (
    ...
    SEASON_GUAN_RI_TOKENS, SEASON_WANG_RI_TOKENS, SEASON_XIANG_RI_TOKENS, TRUC_TOKEN_TO_CODE, capability_inventory, token_capability,
)
...
def test_current_global_capability_is_checked_only_here():
    s=capability_inventory(); assert s["token_count"]==81; assert s["active_calculable_count"]==34; assert s["pending_calculator_count"]==47; assert s["extension_version"]=="V3_0E14_XIANG_RI"; assert s["numeric_score"] is None; assert s["numeric_score_status"]=="LOCKED_OFF"
