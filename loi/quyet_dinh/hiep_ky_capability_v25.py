...
quan hệ Chi tháng-ngày. V3.0A mở thêm đúng 月刑 sau khi đã khóa bảng 12 tháng
và bộ tính; mọi token khác vẫn PENDING_CALCULATOR.
"""
...
MONTH_BRANCH_TOKENS = frozenset({"月建", "月破", "三合", "六合", "月害", "月刑"})
...
def capability_inventory() -> dict:
    ...
    return {
        ...
        "coverage": "12_TRUC_PLUS_MONTH_BRANCH_6",
