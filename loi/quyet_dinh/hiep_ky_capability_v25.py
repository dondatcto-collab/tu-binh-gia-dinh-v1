...
V3.0E19 mở 天馬 theo Chi tháng + Chi ngày; mọi token khác chưa có calculator vẫn PENDING_CALCULATOR.
"""
...
MONTH_TIAN_HOU_TOKENS=frozenset({"天后"})
MONTH_TIAN_MA_TOKENS=frozenset({"天馬"})

def token_capability(token:str)->dict:
    groups=(
        (TRUC_TOKEN_TO_CODE,"12_TRUC_EXISTING_V1"),
        (MONTH_BRANCH_TOKENS,"MONTH_BRANCH_RELATIONS_V25_V30D"),
        (MONTH_BRANCH_DAY_STEM_TOKENS,"MONTH_BRANCH_DAY_STEM_V30E3"),
        (SEASON_DAY_STEM_TOKENS,"SEASON_DAY_STEM_V30E4"),
        (MONTH_BRANCH_DAY_PILLAR_TOKENS,"MONTH_BRANCH_DAY_PILLAR_V30E5"),
        (SEASON_DAY_PILLAR_TOKENS,"SEASON_DAY_PILLAR_V30E6"),
        (SEASON_DAY_BRANCH_TOKENS,"SEASON_DAY_BRANCH_V30E7"),
        (DAY_BRANCH_TOKENS,"DAY_BRANCH_V30E8"),
        (MONTH_BRANCH_DAY_BRANCH_TOKENS,"MONTH_BRANCH_DAY_BRANCH_V30E9"),
        (PAIRED_MONTH_DAY_BRANCH_TOKENS,"MONTH_BRANCH_DAY_BRANCH_V30E10_GIAI_THAN"),
        (QUARTERED_MONTH_DAY_BRANCH_TOKENS,"MONTH_BRANCH_DAY_BRANCH_V30E11_WU_FU"),
        (SEASON_WANG_RI_TOKENS,"SEASON_DAY_BRANCH_V30E12_WANG_RI"),
        (SEASON_GUAN_RI_TOKENS,"SEASON_DAY_BRANCH_V30E13_GUAN_RI"),
        (SEASON_XIANG_RI_TOKENS,"SEASON_DAY_BRANCH_V30E14_XIANG_RI"),
        (SEASON_MIN_RI_TOKENS,"SEASON_DAY_BRANCH_V30E15_MIN_RI"),
        (MONTH_LIN_RI_TOKENS,"MONTH_BRANCH_DAY_BRANCH_V30E16_LIN_RI"),
        (MONTH_YI_MA_TOKENS,"MONTH_BRANCH_DAY_BRANCH_V30E17_YI_MA"),
        (MONTH_TIAN_HOU_TOKENS,"MONTH_BRANCH_DAY_BRANCH_V30E18_TIAN_HOU"),
        (MONTH_TIAN_MA_TOKENS,"MONTH_BRANCH_DAY_BRANCH_V30E19_TIAN_MA"),
    )
...
def capability_inventory()->dict:
    tokens=sorted({item.token for item in all_evidence()}); rows=[token_capability(t) for t in tokens]
