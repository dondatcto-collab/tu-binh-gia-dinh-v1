...
V3.0E8 mở 五合 theo Chi ngày Dần/Mão; không phụ thuộc tháng hay Can ngày.
V3.0E9 mở 天醫 theo Chi tháng + Chi ngày; không phụ thuộc Can ngày.
...
COVERAGE = "V3_0E9_PARTIAL_12_TRUC_PLUS_MONTH_BRANCH_11_PLUS_DAY_STEM_3_PLUS_SEASON_STEM_1_PLUS_DAY_PILLAR_1_PLUS_SEASON_DAY_PILLAR_1_PLUS_SEASON_BRANCH_1_PLUS_DAY_BRANCH_1_PLUS_MONTH_DAY_BRANCH_1"
ACTIVE_EXTRA_TOKENS = frozenset({"月建","月破","三合","六合","月害","月刑","劫煞","災煞","月煞","月厭","時徳","月徳","月徳合","月恩","四相","天願","天赦","天喜","五合","天醫"})
...
def evaluate_event_v25(base_event: dict[str, Any], personal: dict[str, Any], *, chi_thang: str, chi_ngay: str, can_ngay: str | None = None) -> dict[str, Any]:
    ...
    return {
        **out,
        ...
        "coverage": COVERAGE,"hiep_ky_extension": "V3_0E9_TIAN_YI",
