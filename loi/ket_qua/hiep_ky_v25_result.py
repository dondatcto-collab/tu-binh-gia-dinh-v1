...
def v25_schema_overlay(base: dict[str, Any]) -> dict[str, Any]:
    ...
    month_calc = "MONTH_BRANCH_RELATIONS_V25_V30D"
    out.update({
        ...
        "hiep_ky_v30e1": _rule_block("V3_0E1_YUE_DE", "PARTIAL_ACTIVE_ONE_ADDITIONAL_RULE", "月徳", "Nguyệt Đức", "MONTH_BRANCH_DAY_STEM_V30E1", "欽定協紀辨方書 卷五 · 月徳", "FAVORABLE_SUPPORT_ONLY"),
...
def event_search_v25(raw: dict[str, Any]) -> dict[str, Any]:
    ...
    out["hiep_ky_extension"] = "V3_0E1_YUE_DE"
